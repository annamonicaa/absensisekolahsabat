      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item"><a href="/attendance">Absensi</a></li>
            ...
            <div class="card shadow no-border">
                ...
                <div class="card-body">
                    ...
                    {{-- <form method="POST" action="{{ route('attendance.destroy', ['meetingId' => $meetingId, 'ukssId' => $ukssId]) }}" style="display: inline;">
                        @csrf
                        @method('DELETE')
                        <button type="submit" class="btn" onclick="return confirm('Are you sure you want to delete this group of attendance records?')">
